...
<form action="expertDetailProfileAction.do" method="post">
	...
	<textarea rows="10" cols="50">${expert.expert_Id} </textarea> 
	...
	<h2>한줄소개</h2>
	<textarea rows="5" cols="100" name="한줄소개"> ${profile.ep_LineLetter} </textarea> <br>
	<h2>상세소개</h2>
	<textarea rows="10" cols="100">${profile.ep_DetailLetter} </textarea> <br>
