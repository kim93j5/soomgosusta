$(document).ready(function(){
	$('#1_btn').click(function(){
		...
		alert($('#first_select').find('#category1').val());
		if($('#first_select').find('#category1').val() == '레슨'){
			$('#second_select1').css('display','block');
			$('#2_btn').click(function(){
				$('#second_select1').css('display','none');
				if($('#second_select1').find('#category2_select').val() == '악기'){
					$('#third_select1').css('display','block');
					$('#4_btn').click(function(){
						$('#third_select1').css('display','none');
					});
				}else if($('#second_select').find('#category2_select').val() == '학업'){
					$('#lessonStudyForm').css('display','block');
				}
			});
		}else if($('#first_select').find('#category1_select').val() == '서비스'){
...
/*	   var sel_sido;
	   var sel_sido_idx;
	         ...
	         var area0 = [{item:'시/도 선택'}, {item:'서울특별시'}, {item:"인천광역시"}, {item:"대전광역시"}, {item:"광주광역시"},
	            {item:"대구광역시"}, {item:"울산광역시"}, {item:"부산광역시"}, {item:"경기도"}, {item:"강원도"}, {item:"충청북도"}, {item:"충청남도"},
	            {item:"전라북도"}, {item:"전라남도"}, {item:"경상북도"}, {item:"경상남도"}, {item:"제주도"} ];
	         var area1 = [ {item:"강남구"}, {item:"강동구"}, {item:"강북구"}, {item:"강서구"}, {item:"관악구"}, {item:"광진구"}, {item:"구로구"},
	            ...
	            {item:"중구"}, {item:"중랑구"} ];         
	         var area2 = [ {item:"계양구"}, {item:"남구"}, {item:"남동구"}, {item:"동구"}, {item:"부평구"}, {item:"서구"}, {item:"연수구"}, {item:"중구"},
	            {item:"강화군"}, {item:"옹진군"} ];
	         var area3 = [ {item:"대덕구"}, {item:"동구"}, {item:"서구"}, {item:"유성구"}, {item:"중구"} ];
	         var area4 = [{item:"광산구"}, {item:"남구"}, {item:"동구"}, {item:"북구"}, {item:"서구"} ];
	         var area5 = [ {item:"남구"}, {item:"달서구"}, {item:"동구"}, {item:"북구"}, {item:"서구"}, {item:"수성구"}, {item:"중구"}, {item:"달성군"} ];
	         var area6 = [{item: "남구"}, {item:"동구"}, {item:"북구"}, {item:"중구"}, {item:"울주군"} ];
	         var area7 = [ {item:"강서구"}, {item:"금정구"}, {item:"남구"}, {item:"동구"}, {item:"동래구"}, {item:"부산진구"}, {item:"북구"}, {item:"사상구"},
	            {item:"사하구"}, {item:"서구"}, {item:"수영구"}, {item:"연제구"}, {item:"영도구"}, {item:"중구"}, {item:"해운대구"}, {item:"기장군"} ];
	         var area8 = [{item: "고양시"}, {item:"과천시"}, {item:"광명시"}, {item:"광주시"}, {item:"구리시"}, {item:"군포시"}, {item:"김포시"},
	         ...
	         var area9 = [ {item:"강릉시"}, {item:"동해시"}, {item:"삼척시"}, {item:"속초시"}, {item:"원주시"}, {item:"춘천시"}, {item:"태백시"},
	            {item:"고성군"}, {item:"양구군"}, {item:"양양군"}, {item:"영월군"}, {item:"인제군"}, {item:"정선군"}, {item:"철원군"}, {item:"평창군"},
	            {item:"홍천군"}, {item:"화천군"}, {item:"횡성군"} ];
	         var area10 = [ {item:"제천시"}, {item:"청주시"}, {item:"충주시"}, {item:"괴산군"}, {item:"단양군"}, {item:"보은군"}, {item:"영동군"},
	            {item:"옥천군"}, {item:"음성군"}, {item:"증평군"}, {item:"진천군"}, {item:"청원군"} ];
	         var area11 = [ {item:"계룡시"}, {item:"공주시"}, {item:"논산시"}, {item:"보령시"}, {item:"서산시"}, {item:"아산시"}, {item:"천안시"},
	            {item:"금산군"}, {item:"당진군"}, {item:"부여군"}, {item:"서천군"}, {item:"연기군"}, {item:"예산군"}, {item:"청양군"}, {item:"태안군"},{item:"홍성군"} ];
	         var area12 = [ {item:"군산시"}, {item:"김제시"}, {item:"남원시"}, {item:"익산시"}, {item:"전주시"}, {item:"정읍시"}, {item:"고창군"},
	            {item:"무주군"}, {item:"부안군"}, {item:"순창군"}, {item:"완주군"}, {item:"임실군"}, {item:"장수군"}, {item:"진안군"} ];
	         var area13 = [{item: "광양시"}, {item:"나주시"}, {item:"목포시"}, {item:"순천시"}, {item:"여수시"}, {item:"강진군"}, {item:"고흥군"},
	         ...
	         var area14 = [ {item:"경산시"}, {item:"경주시"}, {item:"구미시"}, {item:"김천시"}, {item:"문경시"}, {item:"상주시"}, {item:"안동시"},
	         ...
	         var area15 = [{item: "거제시"}, {item:"김해시"}, {item:"마산시"}, {item:"밀양시"}, {item:"사천시"}, {item:"양산시"}, {item:"진주시"},
